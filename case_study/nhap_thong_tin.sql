use case_study;
 ...
 ("Massage", 50, 30000.0, 2, "SVRO-123", "MS", 2,2 , 20, 3),
 ("Don Phong", 50, 20000.0, 1, "SVRO-321", "DP", 1,1, 20, 2);
 
 insert into bo_phan (`name`) values ("Le Tan"),("F&B"),("Don Phong"),("Dich Vu"),("Sale");
 
 insert into vi_tri (`name`) values ("Nhan Vien"),("Quan Ly"),("Truong Phong"),("Giam Doc");
 
 insert into trinh_do (`name`) values ("Dai Hoc"),("Cao Dang"), ("THPT");
 
 insert into nhan_vien (ho, ten, ngay_sinh, so_cmnd, luong, so_dien_thoai, email, dia_chi, ma_vi_tri, ma_trinh_do, ma_bo_phan) values
 ...
 insert into loai_khach (ten_loai_khach) values ("Diamon"), ("Gold"),("Silver");
 
 insert into khach_hang (ma_loai_khach_hang, ho, ten, ngay_sinh, gioi_tinh, so_cmnd, so_dien_thoai, email, dia_chi) values
 (1, "Chien","Tran", "2005-05-12", 1, "2222345621", "0656212323", "chien.tran@gmail.com", "Quang Binh"),
 ...
 ("Buffet", 1500.0, "VND", "Co"),
 ("Bua Toi", 2000.0, "VND", "Co"),
 ("Giu Tre", 1500.0, "VND","Co"),
 ("Spa", 1500.0, "VND","Co"),
 ("Coffe", 1500.0, "VND","Co");
